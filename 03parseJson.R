...
download.file("https://s3-eu-west-1.amazonaws.com/targetvalidation-dumps/16.08_association_data.json.gz", "../data/open_targets_association_data.json.gz")
dat <- stream_in(gzfile("../data/open_targets_association_data.json.gz"))
